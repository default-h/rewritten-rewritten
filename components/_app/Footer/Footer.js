...
const Footer = () => {
  return (
    <footer className={styles.container}>
      <h3 className={styles.title}>Stay Up &#34;TOON&#34; Date!</h3>
      <div className={styles.socials}>
        ...
        >
          ...
          >
            ...
            <path
              fill='#FDFDFD'
              className={[styles.facebook, styles.icons].join(' ')}
        ...
        >
          ...
          >
            ...
            <path
              fill='#FDFDFD'
              className={[styles.twitter, styles.icons].join(' ')}
        ...
        >
          ...
          >
            ...
            <path
              fill='#FDFDFD'
              className={[styles.instagram, styles.icons].join(' ')}
        ...
        >
          ...
          >
            ...
            <path
              fill='#FDFDFD'
              className={[styles.discord, styles.icons].join(' ')}
        ...
        >
          ...
          >
            ...
            <path
              fill='#FDFDFD'
              className={[styles.youtube, styles.icons].join(' ')}
        ...
        >
          ...
          >
            ...
            <path
              fill='#FDFDFD'
              className={[styles.twitch, styles.icons].join(' ')}
